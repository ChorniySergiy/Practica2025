      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mb-2 mb-lg-0 langs">
          <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                  ...
                  <li><a class="dropdown-item" href="<?php echo e(route('switchLang', ['locale' => 'ua'])); ?>">🇺🇦 Українська</a></li>
              </ul>
          </li>
      </ul>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo e(route('switchLang', ['locale' => 'en'])); ?>">🇬🇧 English</a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('switchLang', ['locale' => 'uc'])); ?>">🇺🇦 Українська</a></li>
            </ul>
        </li>
        -->
      </div>
